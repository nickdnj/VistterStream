...
const PTZControlPanel: React.FC<PTZControlPanelProps> = ({ camera, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-dark-900/95 flex items-center justify-center overflow-hidden">
      <div className="w-full max-w-6xl mx-4 bg-dark-800 rounded-xl border border-dark-600 shadow-2xl overflow-hidden flex flex-col max-h-[95vh]">
        {/* Header */}
        ...
        <div className="flex flex-col lg:flex-row flex-1 min-h-0 overflow-y-auto lg:overflow-hidden overscroll-contain">
          {/* Left: Live Preview */}
          <div className="lg:w-[65%] p-4 flex flex-col min-h-0 shrink-0">
          ...
          <div className="lg:w-[35%] border-t lg:border-t-0 lg:border-l border-dark-600 p-4 flex flex-col gap-5 lg:overflow-y-auto min-h-0 overscroll-contain">
            {/* D-Pad */}
            <div>
