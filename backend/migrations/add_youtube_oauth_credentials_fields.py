"""Database migration: Add YouTube OAuth credential fields (client_id, client_secret, redirect_uri) to streaming_destinations table"""
...
def run_migration():
    print("=" * 60)
    print("YouTube OAuth Credentials Fields Migration")
    print("=" * 60)
    print()
