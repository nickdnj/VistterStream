...
async def get_config(
    ...
    return ConfigRead(
        ...
        enabled=config.enabled,
        camera_id=config.camera_id,
        motion_threshold=config.motion_threshold or 0.6,
        brightness_threshold=config.brightness_threshold or 0.5,
        activity_threshold=config.activity_threshold or 0.7,
